...
//   document.querySelector('#stop').onclick = async (e) => {
//     stop();
  
//     // Obtener el blob de audio
//     const audioBlob = await getAudioBlob();
  
//     // Crear un objeto FormData para enviar el blob
...
//   // Función para obtener el blob de audio
//   async function getAudioBlob() {
//     return new Promise((resolve, reject) => {
//       // Obtener el blob del elemento de audio
//       const audioElement = document.querySelector('#audio');
//       audioElement.addEventListener('canplay', () => {
//         const blob = base64ToBlob(audioElement.src);
//         resolve(blob);
//       });
//     });
//   }
