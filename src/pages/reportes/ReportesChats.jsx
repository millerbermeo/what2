          ...
          <div className="overflow-x-auto px-10 bg-gray-100 py-8 rounded-lg mb-10">
            ...
            {/* {data.table && data.table.map((item, index) => (
              <div key={index} className='flex justify-between border-b my-5 pb-2'>
                <span className='text-xl'>Reporte Tipo:</span>
                <span>{item.Tipo}</span> 
              </div>
            ))} */}
            ...
            <div className='flex justify-between border-b my-5 pb-2'>
              <span className='text-xl'>Total de mensajes en rango de fechas:</span>
              <span>{data.total_mensajes_en_fechas}</span>
            </div>
            <div className='flex justify-between border-b my-5 pb-2'>
              <span className='text-xl'>Fecha Inicio</span>
              <span>{data.fecha_inicio}</span>
            </div>
            <div className='flex justify-between border-b my-5 pb-2'>
              <span className='text-xl'>Fecha Fin</span>
