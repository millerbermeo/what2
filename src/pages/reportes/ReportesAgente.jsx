...
function ReportesAgente() {
    ...
    const fetchData = async () => {
        try {
            ...
            await axios.post(`${baseURL}/chat_business2/Dashboard/Dashboard/api_reporte_agente.php`).then((response) => {
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className='flex gap-2 items-center'>
                                ...
                                <select id="agentSelect" ref={agente} className="px-3 py-2 border border-gray-300 rounded-lg">
                                    ...
                                    <option value="agente3">Agente 3</option>                            {/* Agrega más opciones según sea necesario */}
                                </select>
                            </div>
